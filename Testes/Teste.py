...
class Cla_Cli:
    ...
    def Get_Nome1(self):
        return self._Nome1
    def Set_Nome1(self, New):
        self._Nome1 = New
        
    def Get_Nome2(self):
        return self._Nome2
    def Set_Nome2(self, New):
        self._Nome2 = New
        
    def Get_Idade(self):
        return self._Idade
    def Set_Idade(self, New):
        self._Idade = New
    ...
    def Titular(self):
        return f"{self.Get_Nome1()} {self.Get_Nome2()}"
...
class Cla_CT(Cla_Cli):
    ...
    def Fazer_Pix(self):
        ...
        if Valor > 0:
            ...
            print(f"\nNovo Saldo: R$ {self.Get_Saldo():.2f}")
        else:
...
c1 = Cla_CT("Joseph", "Maria", "24", "0123")
Contas_Criadas.append(c1)
print(c1.Info())
...
def Menu(Conta_Ativa):
    ...
    while True:
        ...
        try:
            Ops = str(input("Digite uma Opção: "))
        except:
            print("Entrada Errada...")
            continue
    ...
    while True:
        ...
        if Conta_Log:
            if Conta_Log.Get_Senha() == Senha:
                ...
                Menu(Conta_Log) # Passa a conta logada para o Menu
